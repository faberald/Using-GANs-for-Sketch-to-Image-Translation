...
channels = 3
latent_dim = 8
lambda_pixel = 10 # pixel loss weight
...
generator = UnetGenerator1(latent_dim, channels, img_height, img_width)
encoder = UnetEncoder(latent_dim, input_shape)
D_VAE = NLayerDiscriminator(input_shape)
D_LR = NLayerDiscriminator(input_shape)

VGG = make_encoder(model_file="./vgg19.pth")
